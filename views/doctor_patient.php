...
if($session['role'] == 'admin'){
    ...
    $sql = "SELECT * FROM appointment where status= 1 AND doctor_id = '{$session['id']}'";
}
                                           ...
                                           <tr>
                                                ...
                                                <td>
                                                    <select name="approval" id="approval<?php echo $val['id']?>" onchange="approve_appointment('<?php echo $val['id'];?>')">
                                                        ...
                                                        <option value="0" <?php if($val['status'] == 0){ echo 'selected';}?>>De-active</option>
                                                    </select>
                                                </td>
                                                <?php }?>
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                        ...
                                                        <a class="btn btn-outline-secondary" href="./add_prescription.php?id=<?php echo $val['id']; ?>">Add Prescription </a>
                                                    </div>
                                                </td>
