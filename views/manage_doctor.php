...
check_login();
    ...
    if($session['role'] == 'admin'){
        ...
        $sql = "SELECT * FROM users WHERE role = 'Doctor' AND id = '{$session['id']}'";
    }
                                        ...
                                        <?php 
                                            ...
                                            <tr>
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                     <a href="./edit_doctor.php?id=<?php echo $val['id']; ?>" class="btn btn-outline-secondary"><i class="icofont-edit text-success"></i></a>
